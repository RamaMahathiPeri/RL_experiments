...
import torch
import numpy as np
import utils as ut  # Ensure utils.py is available with necessary functions
...
class ChangingMapFrozenLakeEnv(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        return self.env.reset(**kwargs)  # Returns (observation, info)
...
for stage, hole_percentage in enumerate(curriculum, 1):
    ...
    eval_callback = EvalCallback(eval_env,
                                 ...
                                 eval_freq=1000,  # Adjust eval_freq as needed
                                 n_eval_episodes=10,
