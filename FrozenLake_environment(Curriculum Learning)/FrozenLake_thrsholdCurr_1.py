...
performance_threshold = 0.80  # Agent must achieve 90% success rate to move to next stage
evaluation_episodes = 5      # Number of episodes to evaluate the agent
max_timesteps_per_stage = 300000  # Maximum timesteps to train per stage to prevent infinite loops

# **Modification 1: Check for Existing Saved Models Before Training**
# Initialize the latest_stage variable
latest_stage = 0
for stage in range(len(curriculum), 0, -1):
