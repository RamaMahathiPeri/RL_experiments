...
size = 4
PPO_Path='/Users/ramamahathiperi/Desktop/RL_Nick/04_FrozenLake_CurriculumLearning /Training/Saved_Models_Stage_4/FrozenLake_Stage_4.zip'
...
curriculum = [0.01, 0.05, 0.1,0.2]  # Start with 1% holes, then 5%, then 10%, then 20%.
