...
def create_custom_map(size=10, hole_percentage=0.05):
...
def generate_valid_map(size=10, hole_percentage=0.05):
    max_attempts = 1000
...
custom_map = generate_valid_map(size=10, hole_percentage=0.05) 

DQN_Path = ('/Users/ramamahathiperi/Desktop/RL_Nick/03_FrozenLake-environment /Training/Saved Models_custom_cur5%/FrozenLake_custom_cur5%.zip')
