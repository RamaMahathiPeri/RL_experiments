...
env = gym.make(environment_name, desc=None, map_name='4x4',is_slippery=True,render_mode='human')
...
log_path = os.path.join('Training', 'Logs_20k')
...
model = DQN('MlpPolicy', env, verbose=1, tensorboard_log=log_path, device="mps",
...
checkpoint_dir = os.path.join('Training', 'Saved Models_20k', 'checkpoints_20k')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='FrozenLake_dqn20k'
)

# Save the VecNormalize statistics during training
#vec_normalize_stats_path = os.path.join('Training', 'Saved Models_2l', 'vec_normalize_2l.pkl')
...
# Saving the model
DQN_Path = os.path.join('Training', 'Saved Models_20k', 'FrozenLake_Dqn20k')
...
#training_log_path = os.path.join('/Users/ramamahathiperi/Desktop/RL_Nick/02_Car-environment/Training/Logs_2l/')
