...
log_path = os.path.join('Training', 'Logs_2l')
...
checkpoint_dir = os.path.join('Training', 'Saved Models_2l', 'checkpoints_2l')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='FrozenLake_dqn2l'
)
...
# Saving the model
DQN_Path = os.path.join('Training', 'Saved Models_2l', 'FrozenLake_Dqn2l')
