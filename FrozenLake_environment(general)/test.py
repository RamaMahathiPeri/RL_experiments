...
log_path = os.path.join('Training', 'Logs_3l_8x8')
...
checkpoint_dir = os.path.join('Training', 'Saved Models_3l_8x8', 'checkpoints')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='FrozenLake_dqn3l_8x8'
)
...
eval_callback = EvalCallback(
    eval_env,
    best_model_save_path=os.path.join('Training', 'Saved Models_3l_8x8', 'best_model'),
    log_path=os.path.join('Training', 'Logs_3l_8x8', 'eval'),
...
# Saving the model
DQN_Path = os.path.join('Training', 'Saved Models_3l_8x8', 'FrozenLake_Dqn3l')
