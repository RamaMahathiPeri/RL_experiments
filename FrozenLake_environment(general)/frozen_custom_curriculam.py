...
def generate_valid_map(size=10, hole_percentage=0.01):
    max_attempts = 1000
...
log_path = os.path.join('Training', 'Logs_custom_cur1%')
...
checkpoint_dir = os.path.join('Training', 'Saved Models_custom_cur1%', 'checkpoints')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='FrozenLake_custom_cur1%'
)
...
eval_callback = EvalCallback(
    eval_env,
    best_model_save_path=os.path.join('Training', 'Saved Models_custom_cur1%', 'best_model'),
    log_path=os.path.join('Training', 'Logs_custom_cur1%', 'eval'),
...
# Saving the model
DQN_Path = os.path.join('Training', 'Saved Models_custom_cur1%', 'FrozenLake_custom_cur1%')
