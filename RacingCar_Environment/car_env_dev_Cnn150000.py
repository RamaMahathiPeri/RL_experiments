...
env = VecNormalize(env, norm_obs=False, norm_reward=True, clip_obs=10.)# Helps to keep a track of the rewards of the 
...
model = PPO('CnnPolicy',env,verbose=1,tensorboard_log=log_path,device="mps",learning_rate=linear_schedule(3e-4),policy_kwargs=policy_kwargs)
...
eval_callback = EvalCallback(
    env,
    best_model_save_path=os.path.join('Training', 'Saved Models', 'best_model_Cnn150000'),
    log_path=os.path.join('Training', 'Logs', 'eval_results_Cnn150000'),
