...
checkpoint_dir = os.path.join('Training', 'Saved Models_2l', 'checkpoints_Cnn2l')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='Car_model_Cnn2l'
)
...
# Saving the model
PPO_Path = os.path.join('Training', 'Saved Models_2l', 'Model_RacingCar_Cnn2l')
