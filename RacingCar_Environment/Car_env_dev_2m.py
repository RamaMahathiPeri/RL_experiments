...
ch_dir=('/Users/ramamahathiperi/Desktop/RL_Nick/02_Car-environment ')
os.chdir(ch_dir)
...
log_path = os.path.join('Training', 'Logs_2m')
...
checkpoint_dir = os.path.join('Training', 'Saved Models_2m', 'checkpoints')
checkpoint_callback = CheckpointCallback(
    save_freq=save_freq,
    save_path=checkpoint_dir,
    name_prefix='Car_model_Cnn2m'
)

# Save the VecNormalize statistics during training
vec_normalize_stats_path = os.path.join('Training', 'Saved Models_2m', 'vec_normalize.pkl')
...
# Saving the model
PPO_Path = os.path.join('Training', 'Saved Models_2m', 'Model_RacingCar_Cnn2m')
...
training_log_path = os.path.join('/Users/ramamahathiperi/Desktop/RL_Nick/02_Car-environment/Training/Logs_2m/')
